  ...
  const handleSubmit = (event) => {
    ...
    if (role === "Student") {
      ...
      if (!validatePassword(password)) {
        setPasswordError(true);
        setPasswordErrorMsg("Mật khẩu phải có ít nhất 6 ký tự");
        return;
      }
  ...
  return (
    <>
      ...
      <Page>
        <Container>
          <FormPanel>
            <Title>Đăng nhập {role}</Title>
            <Subtitle>Chào mừng quay trở lại! Vui lòng nhập thông tin của bạn</Subtitle>
            ...
            <StyledForm onSubmit={handleSubmit}>
              {role === "Student" ? (
                <>
                  <StyledTextField
                    ...
                    helperText={rollNumberError && "Mã sinh viên là bắt buộc"}
                  ...
                  <StyledTextField
                    ...
                    helperText={studentNameError && "Tên là bắt buộc"}
                    onChange={handleInputChange}
                  />
                </>
              ) : (
              ...
              <Row>
                <FormControlLabel
                  ...
                  label="Ghi nhớ tôi"
                />
                <ForgotLink to="#">Quên mật khẩu?</ForgotLink>
              </Row>

              <GradientButton type="submit" disabled={loader}>
                {loader ? <CircularProgress size={24} color="inherit" /> : "Đăng nhập"}
              </GradientButton>

              {role === "Admin" && (
                <SignupRow>
                  <span>Bạn chưa có tài khoản?</span>
                  <SignupLink to="/Adminregister">Đăng ký</SignupLink>
                </SignupRow>
              )}
            </StyledForm>
          </FormPanel>
      ...
      >
        ...
        <span style={{ marginLeft: "12px" }}>Vui lòng chờ...</span>
      </Backdrop>
